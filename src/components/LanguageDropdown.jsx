...
const LANGUAGES = [
  { code: 'en', label: 'English', iso: 'EN', flag: '🇬🇧' },
  { code: 'el', label: 'Ελληνικά', iso: 'GR', flag: '🇬🇷' },
  { code: 'mk', label: 'Македонски', iso: 'MK', flag: '🇲🇰' },
  { code: 'sr', label: 'Српски', iso: 'SR', flag: '🇷🇸' },
  { code: 'bg', label: 'Български', iso: 'BG', flag: '🇧🇬' },
  { code: 'ro', label: 'Română', iso: 'RO', flag: '🇷🇴' },
];
            ...
            {LANGUAGES.map((lang) => (
              <li key={lang.code} role="option" aria-selected={locale === lang.code}>
                ...
                >
                  ...
                  <span className="text-brand-clay/60 text-[10px] tracking-widest">{lang.iso}</span>
                </button>
              </li>
            ))}
          </motion.ul>
